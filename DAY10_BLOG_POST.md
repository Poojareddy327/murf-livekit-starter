# Building FinAssist: A Multilingual Indian Voice AI Agent for Financial Inclusion

*A complete story and step-by-step guide on building an AI voice assistant for Indian banking using Murf Falcon, Deepgram Nova-3, Google Gemini, and LiveKit.*
